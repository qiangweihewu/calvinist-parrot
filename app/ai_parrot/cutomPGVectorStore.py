...
class PGVectorStore(BasePydanticVectorStore):
    ...
    def _connect(self) -> Any:
        ...
        self._engine = create_engine(self.connection_string, creator=getconn, echo=self.debug)
        self._session = sessionmaker(self._engine)

        self._async_engine = create_async_engine(self.async_connection_string, creator=getconn)
